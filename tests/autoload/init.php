...
include __DIR__ . '/init_php_config.php';
require_once __DIR__ . '/init_composer.php';
require_once __DIR__ . '/init_browser.php';
...
// Overwrite important php config!
include __DIR__ . '/init_php_config.php';
